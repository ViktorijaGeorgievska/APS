...
public class AdjacencyListGraph<T> {
    ...
    public void removeVertex(T vertex) {
        // Remove the vertex from all adjacency lists - го бришеме јазолот од сите листи на соседи
        for (Set<T> neighbors : adjacencyList.values()) {
            neighbors.remove(vertex);
        }
        // Remove the vertex's own entry in the adjacency list - потоа го бришеме и клучот од мапата
