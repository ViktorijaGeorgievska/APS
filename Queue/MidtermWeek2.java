        ...
        while (!subjects.isEmpty()) {
            ...
            for (int i = 0; i < subject.numNeededTeachers;) {
                ...
                if (!absentTeachers.contains(teacher)) {
                    ...
                    i++;
                    /* i значи „колку асистенти сум успеала да доделам“, а не „колку асистенти сум извадила од редицата“.
                    Ако асистентот е отсутен → не може да се додели → i не смее да се зголеми.
                    Ако асистентот е присутен → го доделуваме → тогаш i++.
                    */
                }
            }
        }
