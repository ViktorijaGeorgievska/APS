...
//            System.out.println("Listata e prazna");
    ...
    public SLL<E> joinSortedLists_odAna(SLL<E> list1, SLL<E> list2) {
        ...
        while (tmpFirst != null && tmpSecond != null) {
            if (tmpFirst.element.compareTo(tmpSecond.element) < 0) {     // tmpFirst e pomal
                result.insertLast(tmpFirst.element);
                tmpFirst = tmpFirst.succ;
            } else {
                result.insertFirst(tmpSecond.element);
